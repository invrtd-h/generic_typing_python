...
<<<<<<< Updated upstream:syntax/parsetab.py
...
=======
  ...
  ('trait_decl_stmt -> error S_COLON','trait_decl_stmt',2,'p_trait_decl_stmt_err0','parser.py',904),
  ('trait_decl_stmt -> error LP2 error RP2 S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err1','parser.py',908),
  ('assign_stmt -> names assign_expr S_COLON','assign_stmt',3,'p_assign_stmt_err0','parser.py',912),
  ('trait_decl -> TRAIT trait_id error COLON LP2 trait_decl_stmts RP2 S_COLON','trait_decl',8,'p_trait_decl_err0','parser.py',917),
  ('trait_decl -> TRAIT trait_id LP1 class_args error LP2 trait_decl_stmts RP2 S_COLON','trait_decl',9,'p_trait_decl_err1','parser.py',921),
  ('trait_decl -> TRAIT trait_id LP1 class_args RP1 error S_COLON','trait_decl',7,'p_trait_decl_err2','parser.py',925),
  ('trait_decl -> TRAIT trait_id LP1 class_args RP1 LP2 trait_decl_stmts error S_COLON','trait_decl',9,'p_trait_decl_err3','parser.py',929),
  ('trait_decl -> TRAIT trait_id error EXTENDS unary_pred COLON LP2 trait_decl_stmts RP2 S_COLON','trait_decl',10,'p_trait_decl_err4','parser.py',933),
  ('trait_decl -> TRAIT trait_id LP1 class_args error EXTENDS unary_pred COLON LP2 trait_decl_stmts RP2 S_COLON','trait_decl',12,'p_trait_decl_err5','parser.py',937),
  ('trait_decl -> TRAIT trait_id LP1 class_args RP1 COLON error S_COLON','trait_decl',8,'p_trait_decl_err6','parser.py',941),
  ('trait_decl_stmt -> FN COLON error RP2 S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err2','parser.py',946),
  ('trait_decl_stmt -> FN COLON LP2 error S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err3','parser.py',950),
  ('trait_decl_stmt -> VAR COLON error RP2 S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err4','parser.py',954),
  ('trait_decl_stmt -> VAR COLON LP2 error S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err5','parser.py',958),
  ('trait_decl_stmt -> CLS_FN COLON error RP2 S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err6','parser.py',962),
  ('trait_decl_stmt -> CLS_FN COLON LP2 error S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err7','parser.py',966),
  ('trait_decl_stmt -> CLS_VAR COLON error RP2 S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err8','parser.py',970),
  ('trait_decl_stmt -> CLS_VAR COLON LP2 error S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err9','parser.py',974),
  ('trait_decl_stmt -> STATIC_FN COLON error RP2 S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err10','parser.py',978),
  ('trait_decl_stmt -> STATIC_FN COLON LP2 error S_COLON','trait_decl_stmt',5,'p_trait_decl_stmt_err11','parser.py',982),
  ('decl_fn_stmt -> fn_id error RP1 S_COLON','decl_fn_stmt',4,'p_decl_fn_stmt_err0','parser.py',987),
  ('decl_fn_stmt -> fn_id LP1 error S_COLON','decl_fn_stmt',4,'p_decl_fn_stmt_err1','parser.py',991),
  ('decl_fn_stmt -> fn_id LP3 type_var_args RP3 error RP1 S_COLON','decl_fn_stmt',7,'p_decl_fn_stmt_err2','parser.py',995),
  ('decl_fn_stmt -> fn_id LP3 type_var_args RP3 LP1 error S_COLON','decl_fn_stmt',7,'p_decl_fn_stmt_err3','parser.py',999),
  ('decl_fn_stmt -> fn_id error RP3 LP1 pred_args RP1 S_COLON','decl_fn_stmt',7,'p_decl_fn_stmt_err4','parser.py',1003),
  ('decl_fn_stmt -> fn_id LP3 error LP1 pred_args RP1 S_COLON','decl_fn_stmt',7,'p_decl_fn_stmt_err5','parser.py',1007),
  ('unnamed_pred -> pred_name error RP3','unnamed_pred',3,'p_unnamed_pred_err0','parser.py',1037),
  ('decl_stmt -> error RP3 S_COLON','decl_stmt',3,'p_decl_stmt_err0','parser.py',1042),
  ('decl_stmt -> error RP3 COLON unary_pred S_COLON','decl_stmt',5,'p_decl_stmt_err1','parser.py',1046),
  ('decl_stmt -> LP3 error S_COLON','decl_stmt',3,'p_decl_stmt_err2','parser.py',1049),
  ('decl_static_fn_stmt -> static_fn_id error RP1 S_COLON','decl_static_fn_stmt',4,'p_decl_static_fn_stmt_err0','parser.py',1054),
  ('decl_static_fn_stmt -> static_fn_id LP1 error S_COLON','decl_static_fn_stmt',4,'p_decl_static_fn_stmt_err1','parser.py',1058),
  ('decl_static_fn_stmt -> static_fn_id LP3 type_var_args RP3 error RP1 S_COLON','decl_static_fn_stmt',7,'p_decl_static_fn_stmt_err2','parser.py',1062),
  ('decl_static_fn_stmt -> static_fn_id LP3 type_var_args RP3 LP1 error S_COLON','decl_static_fn_stmt',7,'p_decl_static_fn_stmt_err3','parser.py',1066),
  ('decl_static_fn_stmt -> static_fn_id error RP3 LP1 next_preds RP1 S_COLON','decl_static_fn_stmt',7,'p_decl_static_fn_stmt_err4','parser.py',1070),
  ('decl_static_fn_stmt -> static_fn_id LP3 error LP1 next_preds RP1 S_COLON','decl_static_fn_stmt',7,'p_decl_static_fn_stmt_err5','parser.py',1074),
>>>>>>> Stashed changes:parser/parsetab.py
]
